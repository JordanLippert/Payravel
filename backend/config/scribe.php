...
return [
    ...
    'description' => 'Multi-currency payment request management API. Employees submit payment requests in their local currency; the Finance team approves or rejects them.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Get your token by calling POST /api/auth/login.',
    ],
